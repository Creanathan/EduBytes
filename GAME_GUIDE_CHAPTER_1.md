...
- **Active Use**: Specific items unlock new dialogue paths.
...
- **The Butler**: In the **Hallway**, speak to **Jeanne-Paul Leduc**. He will direct you to the Living Room to meet Mr. Souvellier.

### Step 2: Briefing & The Locked Bureau
- **The Partner**: Go left to the **Living Room** and talk to **Thomas Souvellier**.
- **The Goal**: Thomas explains that the local police were sloppy and left a **USB flash drive** in the Crime Scene Bureau. He needs you to fix the digitized logs.
...
- **The Contradiction**: Filter logs for "Beatrix" or search for "Piano." You will find that while her alibi says she was in the Nursery, a sensor log (#005) places her at the **Piano**.
- **The Piano**: (Optional) Visit the Living Room and examine the Piano to confirm the detective's suspicions.
...
- **The Key**: Confronted with the tablet evidence, she will admit to being at the piano and hand over her **Room Key**.

### Step 7: Final Discovery
- **The Nanny's Room**: Return to the **Living Room**. Use the key on the middle door.
- **Conclusion**: Enter the room and examine her belongings (Bed, Dresser, Window) to find the final clues for the chapter.
